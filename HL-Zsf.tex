...
\newcommand{\mSQS}[1]{\HH.\romannumeral #1..6.4..}
...
\newcommand{\takt}[2]{\ensuremath{\substack{\mathbf{#1}\\ \mathbf{#2}}}}
...
\addcontentsline{toc}{part}{Vorwort}
	...
	Bei Akzentparallelen geschieht die Parallelbewegung nicht zwingend in direkt aufeinanderfolgenden Tönen bzw. Akkorden, sondern auf betonten Zählzeiten; Im Falle vom \takt{4}{4}-Takt bspw. wäre eine Parallelbewegung zwischen Schlag \textit{1} und \textit{3} eine Akzentparallele.
	...
	\section{Entstehung des Sixte ajoutée}
	...
	\textit{In der Funktionstheorie gibt es für den Sixte ajoutée das Symbol} \SA\ \textit{bzw.} \sA, \textit{in der Stufentheorie wird der Akkord in Dur als Septakkord auf der zweiten Stufe in erster Umkehrung (Quint-Sextakkord)} \mShoch{2}{6}{5}{}, \textit{und in Moll ebenfalls als Septakkord der ersten Umkehrung der zweiten Stufe, allerdings halbvermindert, gesehen} \mShoch{2}{\ \ 6}{$\circ$5}{}.\\
